...
const COLLEGES = [
  ...
  { en: 'Actuarial and Financial Mathematics',ar:'الرياضيات الإكتوارية والمالية',   min: 88.10 },
  { en: 'Urban Planning & Design',          ar: 'التخطيط والتصميم العمراني',        min: 87.55 },
  { en: 'Architecture & Building Science',  ar: 'العمارة وعلوم البناء',              min: 86.80 },
  { en: 'Agricultural Engineering',         ar: 'الهندسة الزراعية',                 min: 85.35 },
  { en: 'Statistics',                       ar: 'الإحصاء',                            min: 84.30 },
  { en: 'Operations Research',              ar: 'بحوث العمليات',                    min: 83.75 },
  { en: 'Geophysics',                       ar: 'الجيوفيزياء',                        min: 82.75 },
  { en: 'Mathematics',                      ar: 'الرياضيات',                          min: 81.60 },
  { en: 'Applied Economics',                ar: 'الاقتصاد التطبيقي',               min: 78.55 },
  { en: 'Physics',                          ar: 'الفيزياء',                           min: 78.45 },
  { en: 'Biochemistry',                     ar: 'الكيمياء الحيوية',                     min: 78.00 },
  { en: 'Geology',                          ar: 'الجيولوجيا',                            min: 75.30 },
  { en: 'Chemistry',                        ar: 'الكيمياء',                           min: 73.40 },
  { en: 'Food Science & Human Nutrition',   ar: 'علوم الأغذية وتغذية الإنسان',     min: 72.90 },
  { en: 'Microbiology',                     ar: 'الأحياء الدقيقة',                  min: 71.15 },
  { en: 'Plant',                            ar: 'النبات',                             min: 70.00 },
  { en: 'Zoology',                          ar: 'علم الحيوان',                      min: 70.00 },
  { en: 'Animal Production',                ar: 'الإنتاج الحيواني',                 min: 70.00 },
  { en: 'Plant Production Sciences',        ar: 'علوم الإنتاج النباتي',              min: 70.00 },
